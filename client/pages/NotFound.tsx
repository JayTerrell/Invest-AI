...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-background bg-grid flex flex-col items-center justify-center px-6 text-center">
      <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-metal text-primary-foreground glow-brand mb-6">
      ...
      <Link
        to="/terminal"
        className="mt-8 inline-flex items-center h-11 px-6 rounded-xl bg-metal text-primary-foreground font-semibold hover:brightness-110 transition-all glow-brand"
      >
